<?php
    ...
    require_once 'c:/xampp/htdocs/Projetexamen/models/Mdl_auth.php';
    ...
    class Ctrlauths {
        ...
        public function register(){
            ...
            if($this->authModel->findUserByEmailOrUsername($data['email'], $data['nom'])){
    ...
    public function login(){
        ...
        if($this->authModel->findUserByEmailOrUsername($data['nom/email'], $data['nom/email'])){
            //User Found
